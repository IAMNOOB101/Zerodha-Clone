  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2">
          <h4 className=""><i class="fa fa-plus-circle" aria-hidden='true'></i>Your Zerodha Account</h4>
        ...
        <div className="col-4 p-5 mt-2">
          <h4 className=""><i class="fa fa-plus-circle" aria-hidden='true'></i>Funds</h4>
        ...
        <div className="col-4 p-5 mt-2">
          <h4 className=""><i class="fa fa-plus-circle" aria-hidden='true'></i>Console</h4>
        ...
        <div className="col-4 p-5 mt-2">
          <h4 className=""><i class="fa fa-plus-circle" aria-hidden='true'></i>Coin</h4>
          ...
          <a href="/" style={{textDecoration: 'none', lineHeight: '2.5'}}>Buying and Selling through Coun</a><br />
